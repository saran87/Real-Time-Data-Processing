...
def parse_arguments():
	parser = argparse.ArgumentParser(prog='Pak-Track Utility', usage='%(prog)s [options]', argument_default=argparse.SUPPRESS)
	parser.add_argument('--db_host', help='database host' , nargs='?')
	parser.add_argument('--db_port', help='database port',  nargs='?', default=27017, type=int)
	...
	parser.add_argument('--service', help='which service[vibration (or) shock] you want to process')
